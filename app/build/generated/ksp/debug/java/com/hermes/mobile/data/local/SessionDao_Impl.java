...
public final class SessionDao_Impl implements SessionDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfRenameSession;
  ...
  public SessionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSession = new EntityInsertionAdapter<Session>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `sessions` (`id`,`title`,`createdAt`,`updatedAt`,`messageCount`,`isActive`) VALUES (?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfRenameSession = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE sessions SET title = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfIncrementMessageCount = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE sessions SET messageCount = messageCount + 1, updatedAt = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object upsertSession(final Session session, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object renameSession(final String sessionId, final String title,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfRenameSession.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfRenameSession.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object incrementMessageCount(final String sessionId, final long timestamp,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<Session> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsActive = _tmp != 0;
            _item = new Session(_tmpId,_tmpTitle,_tmpCreatedAt,_tmpUpdatedAt,_tmpMessageCount,_tmpIsActive);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Session call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsActive);
            _tmpIsActive = _tmp != 0;
            _result = new Session(_tmpId,_tmpTitle,_tmpCreatedAt,_tmpUpdatedAt,_tmpMessageCount,_tmpIsActive);
          } else {
            _result = null;
          }
          return _result;
