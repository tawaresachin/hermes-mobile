...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<HermesRepository> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<HermesRepository> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(HermesRepository repository) {
